...
> module JBSet (Set, null, member, subset, empty, fromList, toList, insert, delete, sort, union, intersection, crossproduct, difference) where

> import Prelude hiding (null)

> import qualified Data.List as List (nub, delete, insert, sort, null)

> data Set a = Set [a]        -- SAP
...
> subset (Set s1) (Set s2) = foldr f True s1
>     where 
>     f x xs
>      | x `elem` s2 = True && xs
>      | otherwise   = False
